...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setupSharedPreferences() {
        ...
        setColorFromSharedPreferences(sharedPreferences);
    ...
    private void setColorFromSharedPreferences(SharedPreferences sharedPreferences) {
        final String color = sharedPreferences.getString(getString(R.string.pref_color_key), getString(R.string.pref_color_red_value));
